...
const variation = -1 * (cardWidth + space) * (57 + randomNumber) + speed * 11;
  ...
  React.useEffect(() => {
    ...
    const s = () => {
      if (currentTime < endTime) {
        ...
        setTimeout(() => {
          let tmpCards = document.querySelectorAll('.lottery-card');
  ...
  return (
    <React.Fragment>
      <div className='lottery-wrap'>
        <div className='lottery' onClick={ () => nextStep() }>
              ...
              return (
                ...
                <div className='lottery-card' style={{ left: card + 'px' }} key={ i.toString() }>
                  <div className='flipper'>
                    ...
                    <div className='back'
                      style={{
                        backgroundImage: `url(/img/cards/0${ i + 1 }.jpg)`
                      }}
                    ></div>
                  </div>
                </div>
